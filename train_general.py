...
model = build_general_ai_detector(input_shape=(224, 224, 3))

callbacks = [
    EarlyStopping(patience=3, monitor='val_loss', restore_best_weights=True),
    # WEIGHTS ONLY SAVE
    ModelCheckpoint('best_general_model.weights.h5', save_weights_only=True, save_best_only=True, monitor='val_loss'),
